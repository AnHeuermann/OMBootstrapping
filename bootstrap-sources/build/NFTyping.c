...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT219,5,3) {&Flags_DebugFlag_DEBUG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(168)),_OMC_LIT217,MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */)),_OMC_LIT218}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT282,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(143)),_OMC_LIT233,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT114,_OMC_LIT234,_OMC_LIT280,_OMC_LIT281}};
