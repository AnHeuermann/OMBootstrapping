...
#define _OMC_LIT9_data "/OpenModelica/OMCompiler/Compiler/NBackEnd/Util/NBResizable.mo"
...
static const MMC_DEFREALLIT(_OMC_LIT_STRUCT45_6,1.76286855e9);
...
PROTECTED_FUNCTION_STATIC modelica_string omc_NBResizable_optimalValuesToString(threadData_t *threadData, modelica_metatype _optimal_values, modelica_string __omcQ_24in_5Fstr)
{
...

  {
    ...
    _n_loopVar = _names;
    __omcQ_24tmpVar1 = ((modelica_integer) -1073741823); /* defaultValue */
    while(1) {
      tmp13 = 1;
