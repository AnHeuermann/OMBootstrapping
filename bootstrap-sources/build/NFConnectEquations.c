...
#define _OMC_LIT0_data "NFConnectEquations.lookupVarAttr could not find the variable "
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT30,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(66)),_OMC_LIT24,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT25,_OMC_LIT27,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT29}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT43,9,4) {&NFComponent_COMPONENT__desc,_OMC_LIT6,_OMC_LIT16,_OMC_LIT39,_OMC_LIT39,_OMC_LIT41,_OMC_LIT42,MMC_IMMEDIATE(MMC_TAGFIXNUM(4)),_OMC_LIT20}};
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT52,2,4) {&Flags_FlagData_BOOL__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(0 /* false */))}};
#define _OMC_LIT52 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT52)
#define _OMC_LIT53_data "Outputs experimental Base Modelica."
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT55,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(135)),_OMC_LIT49,_OMC_LIT51,_OMC_LIT25,_OMC_LIT52,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT54}};
#define _OMC_LIT55 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT55)
#define _OMC_LIT56_data "nominal"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT56,7,_OMC_LIT56_data);
#define _OMC_LIT56 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT56)
#define _OMC_LIT57_data "$OMC$PositiveMax"
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT59,1,1) {MMC_IMMEDIATE(MMC_TAGFIXNUM(1 /* true */))}};
#define _OMC_LIT59 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT59)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT60,2,4) {&Absyn_Path_IDENT__desc,_OMC_LIT34}};
...
#define _OMC_LIT62_data " equation generated from stream connection"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT62,42,_OMC_LIT62_data);
#define _OMC_LIT62 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT62)
#define _OMC_LIT63_data "abs"
...
#define _OMC_LIT65_data "Connected constants/parameters must be equal"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT65,44,_OMC_LIT65_data);
#define _OMC_LIT65 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT65)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT66,2,5) {&NFExpression_STRING__desc,_OMC_LIT65}};
#define _OMC_LIT66 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT66)
#define _OMC_LIT67_data "AssertionLevel"
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT73,3,8) {&NFType_ENUMERATION__desc,_OMC_LIT68,_OMC_LIT72}};
#define _OMC_LIT73 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT73)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT74,4,7) {&NFExpression_ENUM__LITERAL__desc,_OMC_LIT73,_OMC_LIT70,MMC_IMMEDIATE(MMC_TAGFIXNUM(2))}};
#define _OMC_LIT74 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT74)
#define _OMC_LIT75_data "exposeLocalIOs"
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT75,14,_OMC_LIT75_data);
#define _OMC_LIT75 MMC_REFSTRINGLIT(_OMC_LIT_STRUCT75)
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT76,2,5) {&Flags_FlagData_INT__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(0))}};
#define _OMC_LIT76 MMC_REFSTRUCTLIT(_OMC_LIT_STRUCT76)
#define _OMC_LIT77_data "Introduces top-level inputs/outputs for unconnected input/output connectors at requested levels, provided they are public, 0 meaning top-level (standard Modelica), 1 inputs/outputs of top-level components, >1 going deeper. This flag is particularly useful for FMI export."
static const MMC_DEFSTRINGLIT(_OMC_LIT_STRUCT77,271,_OMC_LIT77_data);
...
static const MMC_DEFSTRUCTLIT(_OMC_LIT_STRUCT79,8,3) {&Flags_ConfigFlag_CONFIG__FLAG__desc,MMC_IMMEDIATE(MMC_TAGFIXNUM(152)),_OMC_LIT75,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT25,_OMC_LIT76,MMC_REFSTRUCTLIT(mmc_none),_OMC_LIT78}};
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_evaluateActualStream(threadData_t *threadData, modelica_metatype _streamCref, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable, modelica_metatype *out_flowCref);
...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_NFConnectEquations_isNoFlow(threadData_t *threadData, modelica_metatype _element, modelica_string _attr, modelica_fnptr _pred, modelica_metatype _variables);
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_isNoFlow(threadData_t *threadData, modelica_metatype _element, modelica_metatype _attr, modelica_fnptr _pred, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_NFConnectEquations_isNoFlowInside(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _variables);
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_isNoFlowInside(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_NFConnectEquations_isNoFlowOutside(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _variables);
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_isNoFlowOutside(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_NFConnectEquations_isNoFlowMinMax(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _streamCref, modelica_metatype _variables);
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_isNoFlowMinMax(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _streamCref, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_evaluateInStream(threadData_t *threadData, modelica_metatype _cref, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_evaluateOperatorArrayConstructorExp(threadData_t *threadData, modelica_metatype _exp, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_evaluateOperatorReductionExp(threadData_t *threadData, modelica_metatype _exp, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_makePositiveMaxCall(threadData_t *threadData, modelica_metatype _flowExp, modelica_metatype _streamExp, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumInside2(threadData_t *threadData, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumOutside2(threadData_t *threadData, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumInside1(threadData_t *threadData, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumOutside1(threadData_t *threadData, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumMap(threadData_t *threadData, modelica_metatype _elements, modelica_fnptr _func, modelica_metatype _flowThreshold, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_streamSumEquationExp(threadData_t *threadData, modelica_metatype _outsideElements, modelica_metatype _insideElements, modelica_metatype _flowThreshold, modelica_metatype _fallback, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_streamEquationGeneral(threadData_t *threadData, modelica_metatype _outsideElements, modelica_metatype _insideElements, modelica_metatype _flowThreshold, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_generateStreamEquations(threadData_t *threadData, modelica_metatype _elements, modelica_metatype _flowThreshold, modelica_metatype _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_makeSmoothCall(threadData_t *threadData, modelica_metatype _arg, modelica_integer _order)
{
  ...
  tmpMeta8 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT5, _OMC_LIT6, tmpMeta1, tmpMeta2, tmpMeta3, tmpMeta4, _OMC_LIT7, _OMC_LIT11, tmpMeta5, tmpMeta6, listArray(tmpMeta7), _OMC_LIT12, _OMC_LIT13);
  ...
  tmpMeta18 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT5, _OMC_LIT6, tmpMeta11, tmpMeta12, tmpMeta13, tmpMeta14, _OMC_LIT7, _OMC_LIT11, tmpMeta15, tmpMeta16, listArray(tmpMeta17), _OMC_LIT12, _OMC_LIT13);
  tmpMeta19 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, tmpMeta8, tmpMeta9, omc_NFExpression_variability(threadData, _arg), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta18), 8)))));
  _callExp = tmpMeta19;
  _return: OMC_LABEL_UNUSED
  return _callExp;
}
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_evaluateActualStreamMul(threadData_t *threadData, modelica_metatype _crefExp, modelica_metatype _actualStreamArg, modelica_metatype _op, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable)
{
  ...
  /* Pattern-matching assignment */
  tmpMeta1 = omc_NFConnectEquations_evaluateOperators(threadData, _crefExp, _sets, _setsArray, _variables, _ctable);
  ...
  _e2 = omc_NFConnectEquations_evaluateActualStream(threadData, omc_NFExpression_toCref(threadData, _actualStreamArg), _sets, _setsArray, _variables, _ctable ,&_flow_cr);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_evaluateActualStream(threadData_t *threadData, modelica_metatype _streamCref, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable, modelica_metatype *out_flowCref)
{
  ...
  {
    _exp = omc_NFConnectEquations_evaluateInStream(threadData, _stream_cref, _sets, _setsArray, _variables, _ctable);
  }
  else
  {
    if((_flow_dir == ((modelica_integer) -1)))
    ...
    else
    {
      ...
      _instream_exp = omc_NFConnectEquations_evaluateInStream(threadData, _stream_cref, _sets, _setsArray, _variables, _ctable);
...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_NFConnectEquations_isNoFlow(threadData_t *threadData, modelica_metatype _element, modelica_string _attr, modelica_fnptr _pred, modelica_metatype _variables)
{
  ...
  // _var has no default value.
  _flow_name = omc_NFExpression_toCref(threadData, omc_NFConnectEquations_flowExp(threadData, _element));

  _attr_oexp = omc_NFConnectEquations_lookupVarAttr(threadData, _flow_name, _attr, _variables);
  ...
  if(isSome(_attr_oexp))
  {
    ...
    _var = omc_NFExpression_variability(threadData, _attr_exp);

    if((((modelica_integer)_var == 3) && (!omc_NFStructural_isExpressionNotFixed(threadData, _attr_exp, 0 /* false */, ((modelica_integer) 4)))))
    {
      omc_NFStructural_markExp(threadData, _attr_exp);
    ...
    {
      _attr_exp = omc_NFCeval_evalExp(threadData, _attr_exp, _OMC_LIT21);
    }

    _noFlow = mmc_unbox_boolean((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_pred), 2))) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype)) (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_pred), 1)))) (threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_pred), 2))), _attr_exp) : ((modelica_metatype(*)(threadData_t*, modelica_metatype)) (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_pred), 1)))) (threadData, _attr_exp));
  }
  else
  {
    _noFlow = 0 /* false */;
...
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_isNoFlow(threadData_t *threadData, modelica_metatype _element, modelica_metatype _attr, modelica_fnptr _pred, modelica_metatype _variables)
{
  ...
  _noFlow = omc_NFConnectEquations_isNoFlow(threadData, _element, _attr, _pred, _variables);
...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_NFConnectEquations_isNoFlowInside(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _variables)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _noFlow has no default value.
  _noFlow = omc_NFConnectEquations_isNoFlow(threadData, _conn, _OMC_LIT14, boxvar_NFExpression_isNonNegative, _variables);
  _return: OMC_LABEL_UNUSED
  return _noFlow;
}
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_isNoFlowInside(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _variables)
{
  modelica_boolean _noFlow;
  modelica_metatype out_noFlow;
  _noFlow = omc_NFConnectEquations_isNoFlowInside(threadData, _conn, _variables);
  out_noFlow = mmc_mk_icon(_noFlow);
  return out_noFlow;
}
...
PROTECTED_FUNCTION_STATIC modelica_boolean omc_NFConnectEquations_isNoFlowOutside(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _variables)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _noFlow has no default value.
  _noFlow = omc_NFConnectEquations_isNoFlow(threadData, _conn, _OMC_LIT15, boxvar_NFExpression_isNonPositive, _variables);
  _return: OMC_LABEL_UNUSED
  return _noFlow;
}
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_isNoFlowOutside(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _variables)
{
  modelica_boolean _noFlow;
  modelica_metatype out_noFlow;
  _noFlow = omc_NFConnectEquations_isNoFlowOutside(threadData, _conn, _variables);
  out_noFlow = mmc_mk_icon(_noFlow);
  return out_noFlow;
}
...
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_isNoFlowMinMax(threadData_t *threadData, modelica_metatype _conn, modelica_metatype _streamCref, modelica_metatype _variables)
{
  modelica_boolean _noFlow;
  modelica_metatype out_noFlow;
  _noFlow = omc_NFConnectEquations_isNoFlowMinMax(threadData, _conn, _streamCref, _variables);
  out_noFlow = mmc_mk_icon(_noFlow);
  return out_noFlow;
}
  ...
  // _f2 has no default value.
  {
    ...
    while(1) {
      ...
      while (!listEmpty(_s_loopVar)) {
        ...
        if ((!omc_NFConnectEquations_isNoFlowMinMax(threadData, _s, _streamCref, _variables))) {
          tmp4--;
          break;
        }
      }
    ...
    tmp8_1 = _reducedStreams;
    {
      ...
      for (; tmp8 < 4; tmp8++) {
        ...
        case 2: {
          ...
          _cr = tmpMeta37;
          tmpMeta5 = omc_NFConnectEquations_evaluateInStream(threadData, _cr, _sets, _setsArray, _variables, _ctable);
          goto tmp7_done;
        }
        case 3: {
          ...
          _exp = omc_NFConnectEquations_streamSumEquationExp(threadData, _outside, _inside, tmpMeta38, omc_NFExpression_fromCref(threadData, _streamCref, 0 /* false */), _variables);
          tmpMeta5 = omc_NFConnectEquations_evaluateOperators(threadData, _exp, _sets, _setsArray, _variables, _ctable);
          goto tmp7_done;
        }
        }
        goto tmp7_end;
...
PROTECTED_FUNCTION_STATIC modelica_metatype boxptr_NFConnectEquations_generateInStreamExp(threadData_t *threadData, modelica_metatype _streamCref, modelica_metatype _streams, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable, modelica_metatype _flowThreshold)
{
  ...
  _exp = omc_NFConnectEquations_generateInStreamExp(threadData, _streamCref, _streams, _sets, _setsArray, _variables, _ctable, tmp1);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_evaluateInStream(threadData_t *threadData, modelica_metatype _cref, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable)
{
  ...
  _exp = omc_NFConnectEquations_generateInStreamExp(threadData, _cr, _sl, _sets, _setsArray, _variables, _ctable, omc_Flags_getConfigReal(threadData, _OMC_LIT30));
  _return: OMC_LABEL_UNUSED
  return _exp;
}
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_evaluateOperatorArrayConstructorExp(threadData_t *threadData, modelica_metatype _exp, modelica_metatype _sets, modelica_metatype _setsArray, modelica_metatype _variables, modelica_metatype _ctable)
{
  ...
  _evalExp = omc_NFExpandExp_expand(threadData, _exp, 0 /* false */ ,&_expanded);

  if((!_expanded))
  {
    tmpMeta1 = stringAppend(_OMC_LIT31,omc_NFExpression_toString(threadData, _exp));
    omc_Error_addInternalError(threadData, tmpMeta1, _OMC_LIT32);
  }

  _evalExp = omc_NFConnectEquations_evaluateOperators(threadData, _evalExp, _sets, _setsArray, _variables, _ctable);
  _return: OMC_LABEL_UNUSED
  return _evalExp;
}
            ...
            tmp9_1 = omc_NFFunction_Function_name(threadData, omc_NFCall_typedFunction(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 2)))));
            {
              ...
              for (; tmp9 < 3; tmp9++) {
                ...
                case 0: {
                  ...
                  if (8 != MMC_STRLEN(tmpMeta11) || strcmp(MMC_STRINGDATA(_OMC_LIT34), MMC_STRINGDATA(tmpMeta11)) != 0) goto tmp8_end;
                  /* Pattern matching succeeded */
                  tmp6 = 1 /* true */;
                  goto tmp8_done;
                }
                case 1: {
                  ...
                  if (12 != MMC_STRLEN(tmpMeta12) || strcmp(MMC_STRINGDATA(_OMC_LIT35), MMC_STRINGDATA(tmpMeta12)) != 0) goto tmp8_end;
                  /* Pattern matching succeeded */
                  tmp6 = 1 /* true */;
                  goto tmp8_done;
                }
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_makeInStreamDivCall(threadData_t *threadData, modelica_metatype _sum_exp, modelica_metatype _fallback)
{
  ...
  if(omc_Flags_getConfigBool(threadData, _OMC_LIT55))
  {
  ...
  else
  {
    ...
    tmpMeta4 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta5 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta6 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT37, _OMC_LIT6, _OMC_LIT48, _OMC_LIT47, tmpMeta1, tmpMeta2, _OMC_LIT16, _OMC_LIT11, tmpMeta3, tmpMeta4, listArray(tmpMeta5), _OMC_LIT12, _OMC_LIT13);
    ...
    tmpMeta11 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta12 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta13 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT37, _OMC_LIT6, _OMC_LIT48, _OMC_LIT47, tmpMeta8, tmpMeta9, _OMC_LIT16, _OMC_LIT11, tmpMeta10, tmpMeta11, listArray(tmpMeta12), _OMC_LIT12, _OMC_LIT13);
    tmpMeta14 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, tmpMeta6, tmpMeta7, omc_NFExpression_variability(threadData, _fallback), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta13), 8)))));
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_makePositiveMaxCall(threadData_t *threadData, modelica_metatype _flowExp, modelica_metatype _streamExp, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables)
{
  ...
  _nominal_oexp = omc_NFConnectEquations_lookupVarAttr(threadData, _flow_name, _OMC_LIT56, _variables);
  ...
  if(omc_Flags_getConfigBool(threadData, _OMC_LIT55))
  {
    _fn_node = omc_NFClass_lookupElement(threadData, _OMC_LIT57, omc_NFInstNode_InstNode_getClass(threadData, omc_NFInstNode_InstNode_topScope(threadData, omc_NFComponentRef_node(threadData, _flow_name))), NULL);
    ...
    tmpMeta8 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, _fn, tmpMeta7, omc_NFConnector_variability(threadData, _element), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_fn), 8)))));
  ...
  else
  {
    ...
    tmpMeta12 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta13 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta14 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT58, _OMC_LIT6, _OMC_LIT48, _OMC_LIT47, tmpMeta9, tmpMeta10, _OMC_LIT16, _OMC_LIT11, tmpMeta11, tmpMeta12, listArray(tmpMeta13), _OMC_LIT12, _OMC_LIT13);
    ...
    tmpMeta21 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT58, _OMC_LIT6, _OMC_LIT48, _OMC_LIT47, tmpMeta16, tmpMeta17, _OMC_LIT16, _OMC_LIT11, tmpMeta18, tmpMeta19, listArray(tmpMeta20), _OMC_LIT12, _OMC_LIT13);
    tmpMeta22 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, tmpMeta14, tmpMeta15, omc_NFConnector_variability(threadData, _element), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta21), 8)))));
    _positiveMaxCall = tmpMeta22;
  }

  setGlobalRoot(((modelica_integer) 27), _OMC_LIT59);
  _return: OMC_LABEL_UNUSED
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_makeInStreamCall(threadData_t *threadData, modelica_metatype _streamExp)
{
  ...
  tmpMeta4 = MMC_REFSTRUCTLIT(mmc_nil);
  tmpMeta5 = MMC_REFSTRUCTLIT(mmc_nil);
  tmpMeta6 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT60, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta1, tmpMeta2, _OMC_LIT16, _OMC_LIT11, tmpMeta3, tmpMeta4, listArray(tmpMeta5), _OMC_LIT12, _OMC_LIT13);
  ...
  tmpMeta11 = MMC_REFSTRUCTLIT(mmc_nil);
  tmpMeta12 = MMC_REFSTRUCTLIT(mmc_nil);
  tmpMeta13 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT60, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta8, tmpMeta9, _OMC_LIT16, _OMC_LIT11, tmpMeta10, tmpMeta11, listArray(tmpMeta12), _OMC_LIT12, _OMC_LIT13);
  tmpMeta14 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, tmpMeta6, tmpMeta7, omc_NFExpression_variability(threadData, _streamExp), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta13), 8)))));
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumInside2(threadData_t *threadData, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables)
{
  ...
  _exp = omc_NFConnectEquations_makePositiveMaxCall(threadData, _flow_exp, _stream_exp, _element, _flowThreshold, _variables);
  _return: OMC_LABEL_UNUSED
  return _exp;
}
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumInside1(threadData_t *threadData, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables)
{
  ...
  tmpMeta2 = mmc_mk_box4(19, &NFExpression_BINARY__desc, omc_NFConnectEquations_makePositiveMaxCall(threadData, _flow_exp, _stream_exp, _element, _flowThreshold, _variables), omc_NFOperator_makeMul(threadData, _OMC_LIT16), _stream_exp);
  _exp = tmpMeta2;
  _return: OMC_LABEL_UNUSED
  return _exp;
}
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumOutside1(threadData_t *threadData, modelica_metatype _element, modelica_metatype _flowThreshold, modelica_metatype _variables)
{
  ...
  tmpMeta12 = MMC_REFSTRUCTLIT(mmc_nil);
  tmpMeta13 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT60, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta8, tmpMeta9, _OMC_LIT16, _OMC_LIT11, tmpMeta10, tmpMeta11, listArray(tmpMeta12), _OMC_LIT12, _OMC_LIT13);
  tmpMeta14 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, tmpMeta6, tmpMeta7, omc_NFExpression_variability(threadData, _stream_exp), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta13), 8)))));
  tmpMeta15 = mmc_mk_box4(19, &NFExpression_BINARY__desc, omc_NFConnectEquations_makePositiveMaxCall(threadData, _flow_exp, _stream_exp, _element, _flowThreshold, _variables), omc_NFOperator_makeMul(threadData, _OMC_LIT16), tmpMeta14);
  _exp = tmpMeta15;
  _return: OMC_LABEL_UNUSED
  return _exp;
}
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_sumMap(threadData_t *threadData, modelica_metatype _elements, modelica_fnptr _func, modelica_metatype _flowThreshold, modelica_metatype _variables)
{
  ...
  _tailrecursive: OMC_LABEL_UNUSED
  // _exp has no default value.
  _exp = (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_func), 2))) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype, modelica_metatype, modelica_metatype)) (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_func), 1)))) (threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_func), 2))), listHead(_elements), _flowThreshold, _variables) : ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype, modelica_metatype)) (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_func), 1)))) (threadData, listHead(_elements), _flowThreshold, _variables);

  {
    ...
    {
      _e = MMC_CAR(tmpMeta1);
      tmpMeta2 = mmc_mk_box4(19, &NFExpression_BINARY__desc, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_func), 2))) ? ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype, modelica_metatype, modelica_metatype)) (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_func), 1)))) (threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_func), 2))), _e, _flowThreshold, _variables) : ((modelica_metatype(*)(threadData_t*, modelica_metatype, modelica_metatype, modelica_metatype)) (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_func), 1)))) (threadData, _e, _flowThreshold, _variables), omc_NFOperator_makeAdd(threadData, _OMC_LIT16), _exp);
      _exp = tmpMeta2;
    }
  }
  _return: OMC_LABEL_UNUSED
    ...
    tmp4_2 = listEmpty(_insideElements);
    {
      ...
      for (; tmp4 < 4; tmp4++) {
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          _inside_sum1 = omc_NFConnectEquations_sumMap(threadData, _insideElements, boxvar_NFConnectEquations_sumInside1, _flowThreshold, _variables);

          _inside_sum2 = omc_NFConnectEquations_sumMap(threadData, _insideElements, boxvar_NFConnectEquations_sumInside2, _flowThreshold, _variables);
        ...
        case 2: {
          ...
          if (1 /* true */ != tmp4_2) goto tmp3_end;
          /* Pattern matching succeeded */
          _outside_sum1 = omc_NFConnectEquations_sumMap(threadData, _outsideElements, boxvar_NFConnectEquations_sumOutside1, _flowThreshold, _variables);

          _outside_sum2 = omc_NFConnectEquations_sumMap(threadData, _outsideElements, boxvar_NFConnectEquations_sumOutside2, _flowThreshold, _variables);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_streamEquationGeneral(threadData_t *threadData, modelica_metatype _outsideElements, modelica_metatype _insideElements, modelica_metatype _flowThreshold, modelica_metatype _variables)
{
  ...
  // _src has no default value.
  {
    ...
    while(1) {
      ...
      while (!listEmpty(_s_loopVar)) {
        _s = MMC_CAR(_s_loopVar);
        _s_loopVar = MMC_CDR(_s_loopVar);
        if ((!omc_NFConnectEquations_isNoFlowOutside(threadData, _s, _variables))) {
          tmp5--;
          break;
        }
      }
...

  {
    ...
    for (tmpMeta6 = _outsideElements; !listEmpty(tmpMeta6); tmpMeta6=MMC_CDR(tmpMeta6))
    {
      ...
      _res = omc_NFConnectEquations_streamSumEquationExp(threadData, _outside, _insideElements, _flowThreshold, _OMC_LIT61, _variables);

      _src = omc_ElementSource_addAdditionalComment(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_e), 6))), _OMC_LIT62);

      tmpMeta8 = mmc_mk_box6(3, &NFEquation_EQUALITY__desc, _cref_exp, _res, _OMC_LIT16, _OMC_LIT6, _src);
...

  {
    ...
    while(1) {
      ...
      while (!listEmpty(_s_loopVar)) {
        _s = MMC_CAR(_s_loopVar);
        _s_loopVar = MMC_CDR(_s_loopVar);
        if ((!omc_NFConnectEquations_isNoFlowInside(threadData, _s, _variables))) {
          tmp4--;
          break;
        }
      }
    ...
    tmp8_2 = _outside;
    {
      ...
      for (; tmp8 < 5; tmp8++) {
        ...
        case 2: {
          ...
          tmpMeta31 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT60, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta26, tmpMeta27, _OMC_LIT16, _OMC_LIT11, tmpMeta28, tmpMeta29, listArray(tmpMeta30), _OMC_LIT12, _OMC_LIT13);
          ...
          tmpMeta38 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT60, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta33, tmpMeta34, _OMC_LIT16, _OMC_LIT11, tmpMeta35, tmpMeta36, listArray(tmpMeta37), _OMC_LIT12, _OMC_LIT13);
          tmpMeta39 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, tmpMeta31, tmpMeta32, omc_NFExpression_variability(threadData, _cref2), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta38), 8)))));
          _e1 = tmpMeta39;
          ...
          tmpMeta45 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT60, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta40, tmpMeta41, _OMC_LIT16, _OMC_LIT11, tmpMeta42, tmpMeta43, listArray(tmpMeta44), _OMC_LIT12, _OMC_LIT13);
          ...
          tmpMeta52 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT60, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta47, tmpMeta48, _OMC_LIT16, _OMC_LIT11, tmpMeta49, tmpMeta50, listArray(tmpMeta51), _OMC_LIT12, _OMC_LIT13);
          tmpMeta53 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, tmpMeta45, tmpMeta46, omc_NFExpression_variability(threadData, _cref1), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta52), 8)))));
          _e2 = tmpMeta53;

          _src = omc_ElementSource_mergeSources(threadData, _src1, _src2);
          tmpMeta55 = mmc_mk_box6(3, &NFEquation_EQUALITY__desc, _cref1, _e1, _OMC_LIT16, _OMC_LIT6, _src);
          tmpMeta56 = mmc_mk_box6(3, &NFEquation_EQUALITY__desc, _cref2, _e2, _OMC_LIT16, _OMC_LIT6, _src);
          tmpMeta54 = mmc_mk_cons(tmpMeta55, mmc_mk_cons(tmpMeta56, MMC_REFSTRUCTLIT(mmc_nil)));
          tmpMeta5 = tmpMeta54;
          goto tmp7_done;
        }
        case 3: {
          ...
          if (mmc__uniontype__metarecord__typedef__equal(tmpMeta57,0,5) == 0) goto tmp7_end;
          tmpMeta59 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta57), 2));
          tmpMeta60 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta57), 6));
          if (!listEmpty(tmpMeta58)) goto tmp7_end;
          if (listEmpty(tmp8_2)) goto tmp7_end;
          tmpMeta61 = MMC_CAR(tmp8_2);
          tmpMeta62 = MMC_CDR(tmp8_2);
          if (mmc__uniontype__metarecord__typedef__equal(tmpMeta61,0,5) == 0) goto tmp7_end;
          tmpMeta63 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta61), 2));
          tmpMeta64 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta61), 6));
          if (!listEmpty(tmpMeta62)) goto tmp7_end;
          _cr1 = tmpMeta59;
          _src1 = tmpMeta60;
          _cr2 = tmpMeta63;
          _src2 = tmpMeta64;
          /* Pattern matching succeeded */
          _src = omc_ElementSource_mergeSources(threadData, _src1, _src2);
          tmpMeta65 = mmc_mk_cons(omc_NFEquation_makeCrefEquality(threadData, _cr1, _cr2, _OMC_LIT6, _src), MMC_REFSTRUCTLIT(mmc_nil));
          tmpMeta5 = tmpMeta65;
          goto tmp7_done;
        }
        case 4: {
          ...
          /* Pattern matching succeeded */
          tmpMeta5 = omc_NFConnectEquations_streamEquationGeneral(threadData, _outside, _inside, _flowThreshold, _variables);
          goto tmp7_done;
        }
        }
        goto tmp7_end;
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_generateFlowEquations(threadData_t *threadData, modelica_metatype _elements)
{
  ...
  if(omc_NFConnector_isArray(threadData, _c))
  {
    ...
    /* Pattern-matching assignment */
    {
      ...
      while(1) {
        ...
        if (tmp10 == 0) {
          __omcQ_24tmpVar6 = omc_NFConnector_addSubscripts(threadData, _subs, _e);
  ...
  tmpMeta18 = mmc_mk_box6(3, &NFEquation_EQUALITY__desc, _sum, _OMC_LIT18, omc_NFType_arrayElementType(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c), 3)))), _OMC_LIT6, _src);
  ...
  while(1)
  {
    ...
    tmpMeta20 = mmc_mk_box6(6, &NFEquation_FOR__desc, listHead(_iterators), mmc_mk_some(listHead(_ranges)), _equations, _OMC_LIT6, _src);
...
PROTECTED_FUNCTION_STATIC modelica_metatype omc_NFConnectEquations_makeEqualityAssert(threadData_t *threadData, modelica_metatype _lhsCref, modelica_metatype _lhsSource, modelica_metatype _rhsCref, modelica_metatype _rhsSource)
{
  ...
  {
    tmpMeta2 = mmc_mk_box4(19, &NFExpression_BINARY__desc, _lhs_exp, omc_NFOperator_makeSub(threadData, _elem_ty), _rhs_exp);
    _exp = tmpMeta2;
    ...
    tmpMeta6 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta7 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta8 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT64, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta3, tmpMeta4, _OMC_LIT16, _OMC_LIT11, tmpMeta5, tmpMeta6, listArray(tmpMeta7), _OMC_LIT12, _OMC_LIT13);
    ...
    tmpMeta13 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta14 = MMC_REFSTRUCTLIT(mmc_nil);
    tmpMeta15 = mmc_mk_box14(3, &NFFunction_Function_FUNCTION__desc, _OMC_LIT64, _OMC_LIT6, _OMC_LIT47, _OMC_LIT47, tmpMeta10, tmpMeta11, _OMC_LIT16, _OMC_LIT11, tmpMeta12, tmpMeta13, listArray(tmpMeta14), _OMC_LIT12, _OMC_LIT13);
    tmpMeta16 = mmc_mk_box2(16, &NFExpression_CALL__desc, omc_NFCall_makeTypedCall(threadData, tmpMeta8, tmpMeta9, omc_NFExpression_variability(threadData, _exp), 1, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta15), 8)))));
    _exp = tmpMeta16;

    tmpMeta17 = mmc_mk_box5(23, &NFExpression_RELATION__desc, _exp, omc_NFOperator_makeLessEq(threadData, _elem_ty), _OMC_LIT18, mmc_mk_integer(((modelica_integer) -1)));
    _exp = tmpMeta17;
  }
  else
  {
    tmpMeta18 = mmc_mk_box5(23, &NFExpression_RELATION__desc, _lhs_exp, omc_NFOperator_makeEqual(threadData, _elem_ty), _rhs_exp, mmc_mk_integer(((modelica_integer) -1)));
    _exp = tmpMeta18;
  }

  tmpMeta19 = mmc_mk_box6(9, &NFEquation_ASSERT__desc, _exp, _OMC_LIT66, _OMC_LIT74, _OMC_LIT6, _source);
  _equalityAssert = tmpMeta19;

  while(1)
  {
    if(!(!listEmpty(_iterators))) break;
    tmpMeta20 = mmc_mk_cons(_equalityAssert, MMC_REFSTRUCTLIT(mmc_nil));
    tmpMeta21 = mmc_mk_box6(6, &NFEquation_FOR__desc, listHead(_iterators), mmc_mk_some(listHead(_ranges)), tmpMeta20, _OMC_LIT6, _source);
    _equalityAssert = tmpMeta21;
  ...
  {
    {
      ...
      while(1) {
        ...
        if (tmp4 == 0) {
          __omcQ_24tmpVar8 = omc_NFConnectEquations_makeEqualityEquation(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c1), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c1), 6))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c2), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c2), 6))));
    ...
    {
      {
        ...
        while(1) {
          ...
          if (tmp11 == 0) {
            __omcQ_24tmpVar10 = omc_NFConnectEquations_makeEqualityAssert(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c1), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c1), 6))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c2), 2))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_c2), 6))));
...
}static modelica_metatype closure3_NFConnectEquations_evaluateOperators(threadData_t *thData, modelica_metatype closure, modelica_metatype exp)
{
  modelica_metatype sets = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),1));
  modelica_metatype setsArray = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),2));
  modelica_metatype variables = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),3));
  modelica_metatype ctable = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),4));
  return boxptr_NFConnectEquations_evaluateOperators(thData, exp, sets, setsArray, variables, ctable);
}static modelica_metatype closure4_NFConnectEquations_evaluateOperators(threadData_t *thData, modelica_metatype closure, modelica_metatype exp)
{
  modelica_metatype sets = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),1));
  modelica_metatype setsArray = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),2));
  modelica_metatype variables = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(closure),3));
    ...
    tmp4_1 = _exp;
    {
      ...
      for (; tmp4 < 4; tmp4++) {
            ...
            tmp10_1 = _call;
            {
              ...
              for (; tmp10 < 4; tmp10++) {
                    ...
                    tmp15_1 = omc_NFFunction_Function_name(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_call), 2))));
                    {
                      ...
                      for (; tmp15 < 4; tmp15++) {
                        ...
                        case 0: {
                          ...
                          if (8 != MMC_STRLEN(tmpMeta17) || strcmp(MMC_STRINGDATA(_OMC_LIT34), MMC_STRINGDATA(tmpMeta17)) != 0) goto tmp14_end;
                          /* Pattern matching succeeded */
                          tmpMeta12 = omc_NFConnectEquations_evaluateInStream(threadData, omc_NFExpression_toCref(threadData, listHead((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_call), 6))))), _sets, _setsArray, _variables, _ctable);
                          goto tmp14_done;
                        }
                        case 1: {
                          modelica_metatype tmpMeta18;
                          ...
                          if (12 != MMC_STRLEN(tmpMeta18) || strcmp(MMC_STRINGDATA(_OMC_LIT35), MMC_STRINGDATA(tmpMeta18)) != 0) goto tmp14_end;
                          /* Pattern matching succeeded */
                          tmpMeta12 = omc_NFConnectEquations_evaluateActualStream(threadData, omc_NFExpression_toCref(threadData, listHead((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_call), 6))))), _sets, _setsArray, _variables, _ctable, NULL);
                          goto tmp14_done;
                        }
                        case 2: {
                          modelica_metatype tmpMeta19;
                          ...
                          if (11 != MMC_STRLEN(tmpMeta19) || strcmp(MMC_STRINGDATA(_OMC_LIT80), MMC_STRINGDATA(tmpMeta19)) != 0) goto tmp14_end;
                          /* Pattern matching succeeded */
                        ...
                        case 3: {
                          ...
                          /* Pattern matching succeeded */
                          tmpMeta20 = mmc_mk_box4(0, _sets, _setsArray, _variables, _ctable);
                          tmpMeta12 = omc_NFExpression_mapShallow(threadData, _exp, (modelica_fnptr) mmc_mk_box2(0,closure2_NFConnectEquations_evaluateOperators,tmpMeta20));
                          goto tmp14_done;
                        }
                        }
                        goto tmp14_end;
                ...
                case 1: {
                  ...
                  tmpMeta7 = omc_NFConnectEquations_evaluateOperatorReductionExp(threadData, _exp, _sets, _setsArray, _variables, _ctable);
                  goto tmp9_done;
                }
                case 2: {
                  ...
                  tmpMeta7 = omc_NFConnectEquations_evaluateOperatorArrayConstructorExp(threadData, _exp, _sets, _setsArray, _variables, _ctable);
                  goto tmp9_done;
                }
                case 3: {
                  modelica_metatype tmpMeta21;
                  ...
                  /* Pattern matching succeeded */
                  tmpMeta21 = mmc_mk_box4(0, _sets, _setsArray, _variables, _ctable);
                  tmpMeta7 = omc_NFExpression_mapShallow(threadData, _exp, (modelica_fnptr) mmc_mk_box2(0,closure3_NFConnectEquations_evaluateOperators,tmpMeta21));
                  goto tmp9_done;
                }
                }
                goto tmp9_end;
        ...
        case 1: {
          ...
          /* Pattern matching succeeded */
          /* Check guard condition after assignments */
          if (!omc_AbsynUtil_isNamedPathIdent(threadData, omc_NFFunction_Function_name(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_call), 2)))), _OMC_LIT35)) goto tmp3_end;
          tmpMeta1 = omc_NFConnectEquations_evaluateActualStreamMul(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 2))), listHead((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_call), 6)))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 3))), _sets, _setsArray, _variables, _ctable);
          goto tmp3_done;
        }
        case 2: {
          modelica_metatype tmpMeta28;
          ...
          if (mmc__uniontype__metarecord__typedef__equal(tmpMeta29,2,6) == 0) goto tmp3_end;
          tmpMeta30 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmp4_1), 3));
          if (mmc__uniontype__metarecord__typedef__equal(tmpMeta30,0,2) == 0) goto tmp3_end;
          tmpMeta31 = MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(tmpMeta30), 3));
          tmp32 = mmc_unbox_integer(tmpMeta31);
          if (3 != tmp32) goto tmp3_end;
          ...
          /* Check guard condition after assignments */
          if (!omc_AbsynUtil_isNamedPathIdent(threadData, omc_NFFunction_Function_name(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_call), 2)))), _OMC_LIT35)) goto tmp3_end;
          tmpMeta1 = omc_NFConnectEquations_evaluateActualStreamMul(threadData, (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 4))), listHead((MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_call), 6)))), (MMC_FETCH(MMC_OFFSET(MMC_UNTAGPTR(_exp), 3))), _sets, _setsArray, _variables, _ctable);
          goto tmp3_done;
        }
        case 3: {
          modelica_metatype tmpMeta34;
          ...
          /* Pattern matching succeeded */
          tmpMeta34 = mmc_mk_box4(0, _sets, _setsArray, _variables, _ctable);
          tmpMeta1 = omc_NFExpression_mapShallow(threadData, _exp, (modelica_fnptr) mmc_mk_box2(0,closure4_NFConnectEquations_evaluateOperators,tmpMeta34));
          goto tmp3_done;
        }
        }
        goto tmp3_end;
...
modelica_metatype omc_NFConnectEquations_generateEquations(threadData_t *threadData, modelica_metatype _sets, modelica_metatype _variables, modelica_metatype *out_connectedLocalIOs)
{
  ...
  tmpMeta2 = mmc_mk_box2(4, &NFExpression_REAL__desc, mmc_mk_real(omc_Flags_getConfigReal(threadData, _OMC_LIT30)));
  _flowThreshold = tmpMeta2;

  {
    modelica_metatype _set;
    for (tmpMeta3 = _sets, tmp9 = arrayLength(tmpMeta3), tmp8 = 1; tmp8 <= tmp9; tmp8++)
    {
      _set = arrayGet(tmpMeta3,tmp8);
      _cty = omc_NFConnectEquations_getSetType(threadData, _set);
      ...
      else
      {
        ...
        else
        {
          ...
          {
            _set_eql = omc_NFConnectEquations_generateStreamEquations(threadData, _set, _flowThreshold, _variables);
          }
          else
          {
            tmpMeta4 = stringAppend(_OMC_LIT81,omc_NFPrefixes_ConnectorType_toDebugString(threadData, _cty));
            tmpMeta5 = stringAppend(tmpMeta4,_OMC_LIT82);
            tmpMeta6 = stringAppend(tmpMeta5,omc_List_toString(threadData, _set, boxvar_NFConnector_toString, _OMC_LIT19, _OMC_LIT83, _OMC_LIT84, _OMC_LIT85, 1 /* true */, ((modelica_integer) 0)));
            omc_Error_addInternalError(threadData, tmpMeta6, _OMC_LIT86);
